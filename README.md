# 🎵 Web application de reconnaissance de musique (inspired by Shazam)
...
- 🕒 **Page d’historique**
  ...
  - *Non fonctionnelle à ce jour (amélioration future)*

- ⭐ **Page de favoris**
  - Prévue pour sauvegarder les musiques préférées  
  - *Non fonctionnelle à ce jour (amélioration future)*
...
- Rendre fonctionnelles les pages **Historique** et **Favoris**
- Finaliser et entraîner correctement l’IA de reconnaissance de genre
- Enrichir la base de données musicale
